...
import com.mls.osworks.api.model.OrdemServicoInputModel;
import com.mls.osworks.api.model.OrdemServicoModel;
...
public class OrdemServicoController {
	...
	public OrdemServicoModel criar(@Valid @RequestBody OrdemServicoInputModel ordemServicoInputModel) {
		...
		OrdemServico ordermServico =  toEntity(ordemServicoInputModel);
	...
	public ResponseEntity<OrdemServicoModel> buscar(@PathVariable Long ordemServicoId) {
		...
		if(ordemServico.isPresent()) {
			...
			OrdemServicoModel orderServicoModel = toModel(ordemServico.get());
			
			return ResponseEntity.ok(orderServicoModel);
		} else {
	...
	@PutMapping("/{ordemServicoId}/cancela")
	@ResponseStatus(HttpStatus.NO_CONTENT)
